...
// Ambient-sound CDN used by the Audio Library (rain, ocean, fire, …). White
// noise is self-hosted in public/sounds/, so it needs no extra source.
...
function buildCsp(scriptHashes) {
  ...
  return [
    ...
    `media-src 'self' data: blob: ${MEDIA_MIXKIT}`,
